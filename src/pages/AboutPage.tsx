...
import founderPortrait from '../assets/images/regenerated_image_1788504887795.png';
    ...
    <div id="about-page" className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 space-y-16">
      ...
      <div className="text-center space-y-4 max-w-3xl mx-auto">
        ...
        <p className="text-base text-gray-600 leading-relaxed">
          CRENVORO was established to bridge the gap between world-class design standards and rapid execution for creative agencies, freelancers, and businesses.
        </p>
      </div>
      ...
      <div className="bg-white rounded-3xl p-8 sm:p-12 border border-gray-200/80 shadow-xs flex flex-col md:flex-row items-center gap-10">
        <div className="relative shrink-0">
          <img
            ...
            src={founderPortrait}
            alt="Ibrahim Samrat – Founder & Creative Director"
