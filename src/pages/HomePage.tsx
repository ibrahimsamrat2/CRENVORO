...
import { CrenvoroTile } from '../components/CrenvoroLogo';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="relative bg-gradient-to-br from-purple-900/50 to-gray-900 p-8 rounded-3xl border border-purple-500/30">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  <CrenvoroTile className="w-12 h-12 shadow-lg shadow-purple-900/50" />
                  <div>
                    <div className="font-bold text-white text-sm">CRENVORO Creator Program</div>
          ...
          <div className="space-y-6">
            ...
            <p className="text-sm text-gray-300 leading-relaxed">
              Join CRENVORO Marketplace and start selling your vectors, PSD mockups, templates, and digital assets to thousands of designers, agencies, and businesses across 140+ countries.
            </p>
