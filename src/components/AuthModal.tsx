...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      signInAsDemo(role);
      showToast('Account Ready', `Welcome to CRENVORO Marketplace!`, 'success');
      setIsSubmitting(false);
      onClose();
    }, 400);
  };
    ...
    >
      ...
      >
        ...
        <div className="text-center mb-6">
          <CrenvoroTile className="w-14 h-14 mx-auto mb-3 shadow-xl shadow-purple-900/30" />
          <h2 className="text-2xl font-black text-gray-900 tracking-tight">
            {mode === 'signin' ? 'Welcome Back' : 'Join CRENVORO'}
          </h2>
